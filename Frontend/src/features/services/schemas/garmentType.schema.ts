...
export type CreateGarmentTypeFormData = z.infer<typeof createGarmentTypeSchema>;
export type UpdateGarmentTypeFormData = z.infer<typeof updateGarmentTypeSchema>;
